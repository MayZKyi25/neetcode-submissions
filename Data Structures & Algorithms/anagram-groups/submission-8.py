class Solution:
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
        ...
        # create anagram default dict with lists

        # for word in strs:
            # count = [0] * 26
            # find ord at current word - ord ('a') and increase the count of alphabets by 1
            # check if count is in our anagram? No? --> update it as key
